...
export function wrapNatively(nodule, name, wrapper) {
 ...
 */
export function waitForGlobal(identifier, callback) {
...
export function headerCapture(type, headers) {
    const normalizedHeaders = new Map(headers.map((header) => [header, header.toLowerCase().replace(/-/g, '_')]));
