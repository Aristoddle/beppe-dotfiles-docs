...
exports.SplunkWebSocketInstrumentation = void 0;
...
class SplunkWebSocketInstrumentation extends instrumentation_1.InstrumentationBase {
    constructor(config) {
        super('splunk-websocket', version_1.VERSION, config);
        ...
        function webSocketWrapper() {
            class InstrumentedWebSocket extends WebSocket {
                constructor(url, protocols) {
                    if ((0, core_1.isUrlIgnored)(url, instrumentation._config.ignoreUrls)) {
                        super(url, protocols);
                        return;
                    }
                    ...
                    this.addEventListener('error', function (event) {
                        if (connectSpan.isRecording()) {
                            ...
                            instrumentation.startSpan(this, 'error', api_1.SpanKind.CLIENT).end();
                        }
                    });
    ...
    patchSend(ws) {
        ...
        ws.send = function instrumentedSend(...args) {
            const span = instrumentation.startSpan(ws, 'send', api_1.SpanKind.PRODUCER);
    ...
    patchEventListener(ws) {
        ...
        ws.addEventListener = function instrumentedAddEventListener(type, callback, options) {
            ...
            const patchedCallback = function patchedAddEventListenerCallback(...args) {
                ...
                const span = instrumentation.startSpan(ws, 'onmessage', api_1.SpanKind.CONSUMER);
    ...
    endSpanExceptionally(span, err) {
        ...
        span.setAttribute('error.object', err.name
            ? err.name
...
exports.SplunkWebSocketInstrumentation = SplunkWebSocketInstrumentation;
