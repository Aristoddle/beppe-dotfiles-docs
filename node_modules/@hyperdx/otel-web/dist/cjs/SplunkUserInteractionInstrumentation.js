...
exports.SplunkUserInteractionInstrumentation = exports.DEFAULT_AUTO_INSTRUMENTED_EVENT_NAMES = exports.DEFAULT_AUTO_INSTRUMENTED_EVENTS = void 0;
const api_1 = require("@opentelemetry/api");
const instrumentation_user_interaction_1 = require("@opentelemetry/instrumentation-user-interaction");
exports.DEFAULT_AUTO_INSTRUMENTED_EVENTS = {
    // pointer
    click: true,
    dblclick: true,
    mousedown: true,
...
exports.DEFAULT_AUTO_INSTRUMENTED_EVENT_NAMES = Object.keys(exports.DEFAULT_AUTO_INSTRUMENTED_EVENTS);
...
class SplunkUserInteractionInstrumentation extends instrumentation_user_interaction_1.UserInteractionInstrumentation {
    constructor(config = {}) {
        // Prefer otel's eventNames property
        if (!config.eventNames) {
            const eventMap = Object.assign({}, exports.DEFAULT_AUTO_INSTRUMENTED_EVENTS, config.events);
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const eventNames = Object.entries(eventMap)
                .filter(([_eventName, enabled]) => enabled)
                .map(([eventName]) => eventName);
            config.eventNames = eventNames;
        }
        super(config);
        this._routingTracer = api_1.trace.getTracer(ROUTING_INSTRUMENTATION_NAME, ROUTING_INSTRUMENTATION_VERSION);
...
exports.SplunkUserInteractionInstrumentation = SplunkUserInteractionInstrumentation;
