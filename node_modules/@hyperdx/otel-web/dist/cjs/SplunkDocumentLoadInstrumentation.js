...
exports.SplunkDocumentLoadInstrumentation = void 0;
...
class SplunkDocumentLoadInstrumentation extends instrumentation_document_load_1.DocumentLoadInstrumentation {
    constructor(config = {}) {
        super(config);
        ...
        exposedSuper._endSpan = (span, performanceName, entries) => {
            ...
            if (span && exposedSpan.name !== 'documentLoad') {
                ...
                if (exposedSpan.name === 'documentFetch' &&
                    !entries.serverTiming &&
                    performance.getEntriesByType) {
                    const navEntries = performance.getEntriesByType('navigation');
                    if ((_a = navEntries[0]) === null || _a === void 0 ? void 0 : _a.serverTiming) {
                        entries.serverTiming =
                            navEntries[0].serverTiming;
                    }
                }
                (0, servertiming_1.captureTraceParentFromPerformanceEntries)(entries, span);
        ...
        const _superInitResourceSpan = exposedSuper._initResourceSpan.bind(this);
        exposedSuper._initResourceSpan = (resource, parentSpan) => {
            if (excludedInitiatorTypes.indexOf(resource.initiatorType) !== -1 ||
                (0, core_1.isUrlIgnored)(resource.name, config.ignoreUrls)) {
                return;
            }
...
exports.SplunkDocumentLoadInstrumentation = SplunkDocumentLoadInstrumentation;
